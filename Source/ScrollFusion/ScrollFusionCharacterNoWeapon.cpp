...
AScrollFusionCharacterNoWeapon::AScrollFusionCharacterNoWeapon()
{
...
void AScrollFusionCharacterNoWeapon::SetupPlayerInputComponent(class UInputComponent* InputComponent)
{
...
void AScrollFusionCharacterNoWeapon::BeginTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
void AScrollFusionCharacterNoWeapon::EndTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
void AScrollFusionCharacterNoWeapon::TouchUpdate(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
void AScrollFusionCharacterNoWeapon::MoveForward(float Value)
{
	if (Value != 0.0f)
	{
...
void AScrollFusionCharacterNoWeapon::MoveRight(float Value)
{
	if (Value != 0.0f)
	{
		// add movement in that direction
...
void AScrollFusionCharacterNoWeapon::TurnAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerYawInput(Rate * BaseTurnRate * GetWorld()->GetDeltaSeconds());
}

void AScrollFusionCharacterNoWeapon::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerPitchInput(Rate * BaseLookUpRate * GetWorld()->GetDeltaSeconds());
}

bool AScrollFusionCharacterNoWeapon::EnableTouchscreenMovement(class UInputComponent* InputComponent)
{
	bool bResult = false;
