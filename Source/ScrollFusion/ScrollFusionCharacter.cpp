...
AScrollFusionCharacter::AScrollFusionCharacter()
{
...
void AScrollFusionCharacter::SetupPlayerInputComponent(class UInputComponent* InputComponent)
{
...
void AScrollFusionCharacter::BeginTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
void AScrollFusionCharacter::EndTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
void AScrollFusionCharacter::TouchUpdate(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
void AScrollFusionCharacter::MoveForward(float Value)
{
	if (Value != 0.0f)
	{
...
void AScrollFusionCharacter::MoveRight(float Value)
{
	if (Value != 0.0f)
	{
		// add movement in that direction
...
void AScrollFusionCharacter::TurnAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerYawInput(Rate * BaseTurnRate * GetWorld()->GetDeltaSeconds());
}

void AScrollFusionCharacter::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerPitchInput(Rate * BaseLookUpRate * GetWorld()->GetDeltaSeconds());
}

bool AScrollFusionCharacter::EnableTouchscreenMovement(class UInputComponent* InputComponent)
{
	bool bResult = false;
